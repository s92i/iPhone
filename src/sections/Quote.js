...
const Quote = () => {
    ...
    useLayoutEffect(() => {
        ...
        let trigger = ScrollTrigger.create({ trigger: Elem, start: 'top top', pin: true, pinSpacing: false })
        return () => {
    ...
    return (
        <Section ref={sectionRef}>
            <TextContainer>
                ...
                <Text delay=".4s"><span>&nbsp;&nbsp;&nbsp;you can only connect them looking backward.</span></Text>
                <Text delay=".8s"><span>&nbsp;&nbsp;&nbsp;so you have to trust that the dots</span></Text>
